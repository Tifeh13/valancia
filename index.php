...
<nav class="navbar navbar-expand-lg bg-white navbar-light d-flex 
        ...
        <div class="untree_co-hero overlay" id="home" style="background-image: url('img/mainimg.png');">
            <div class="container">
                ...
                <div class="col-8  px-5 py-3 rounded mx-auto position-absolute event" style="background: #FFF6F7;">
                        ...
                        <div class="py-4 px-5">
                            ...
                            <span class="ms-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8 2V5" stroke="#929292" stroke-width="1.5" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M16 2V5" stroke="#929292" stroke-width="1.5" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M3.5 9.09H20.5" stroke="#929292" stroke-width="1.5" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
